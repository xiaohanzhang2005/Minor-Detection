...
PIPELINE = (BASE_DIR / Path(r"..\codex_home\.codex\skills\minor-detect-488bbc2b22\scripts\run_minor_detection_pipeline.py")).resolve()
PAYLOAD = (BASE_DIR / Path(r"payload.json")).resolve()
RESULT_PATH = (BASE_DIR / Path(r"launcher_result.json")).resolve()
PIPELINE_OBSERVABILITY_PATH = (BASE_DIR / Path(r"pipeline_observability.json")).resolve()
