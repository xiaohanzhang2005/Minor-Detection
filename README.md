...
<p><strong>图中展示的完整能力链路包括：</strong> Trigger 边界判断、多维证据融合、结构化输出、长期用户建模、离线自进化，以及与未成年人模式切换、人工复核、家长侧提醒、审核中台、风险运营等下游环节的衔接。</p>
...
用于启动 Streamlit 前端工作台，直观看系统演示效果。
