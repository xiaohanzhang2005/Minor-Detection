...
PIPELINE = Path(r"D:\重生之我要当桌面\teenager_AI\minor-protection\reports\skill_agent_loops\20260321_211422\baseline\run_minor-detection-v0.1.0\codex_home\.codex\skills\minor-detection-v0.1.0\scripts\run_minor_detection_pipeline.py")
PAYLOAD = Path(r"D:\重生之我要当桌面\teenager_AI\minor-protection\reports\skill_agent_loops\20260321_211422\baseline\run_minor-detection-v0.1.0\eval-0000-social_pos_002016_gemini-3-flash-preview_2017\payload.json")
RESULT_PATH = Path(r"D:\重生之我要当桌面\teenager_AI\minor-protection\reports\skill_agent_loops\20260321_211422\baseline\run_minor-detection-v0.1.0\eval-0000-social_pos_002016_gemini-3-flash-preview_2017\launcher_result.json")
PIPELINE_OBSERVABILITY_PATH = Path(r"D:\重生之我要当桌面\teenager_AI\minor-protection\reports\skill_agent_loops\20260321_211422\baseline\run_minor-detection-v0.1.0\eval-0000-social_pos_002016_gemini-3-flash-preview_2017\pipeline_observability.json")
...
def _split_stream(text):
    ...
    return "
".join(kept_lines).strip(), observability_payload
...
stdout_json, stdout_observability = _split_stream(stdout_text)
stderr_clean, stderr_observability = _split_stream(stderr_text)
observability_payload = stderr_observability or stdout_observability
...
_write_result({
    ...
    "stderr_excerpt": stderr_clean[:2000],
})
