...
- 项目演示视频  
  <https://www.bilibili.com/video/BV1MRXYBgEQk/?spm_id_from=333.1387.homepage.video_card.click>

### 数据规模

| 数据模块 | 作用 | 规模 |
| --- | --- | --- |
| Benchmark | 评估真实未成年人信号与成人近似样本之间的区分能力 | `8,328` 条 |
| RAG 检索案例库 | 提供运行时相似案例辅助判断与离线优化参考 | `5,829` 条 |
| Trigger-Eval | 优化“什么时候该启动深度识别”的触发边界问题 | `160` 条 |

进一步拆开看：

| 子集 | 来源 / 场景 | 规模 |
| --- | --- | --- |
| 社交/心理领域 | 心理咨询平台真实数据整理后的公开边界版本 | `2603` 正 + `1735` 负 |
| 知识领域 | K12 课本、课程知识点与成人考试考纲构造 | `2004` 正 + `1986` 负 |
| Trigger-Eval | `window_scan` 与 `direct_request` 两类触发场景 | `120 + 40` |
