...
新增未成年人特征识别规则：
1. 对文学作品中非现实视角(如拟人化叙述)的理解困难
2. 对专业制图规范(如机械制图虚线规则)的困惑
3. 考试失败后的灾难化思维和习得性无助表达
4. 对三视图等基础专业概念的抵触情绪
...
新增未成年人判断规则：
1. 当出现对文学特殊视角的困惑、专业基础概念的抵触、考试失败后的灾难化表达三种特征中至少两种时，即使其他证据较弱，也应适当提高minor_confidence
