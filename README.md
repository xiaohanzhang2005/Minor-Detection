...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">常见方案问题</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">Minor Detection 的回答</font></th>
  </tr>
  <tr>
    <td>只做一次性年龄猜测</td>
    <td>覆盖触发判断、深度识别、证据链输出、人工复核的完整治理链路</td>
  </tr>
  <tr>
    <td>只看单轮文本</td>
    <td>融合单会话、多会话、时间线索、长期画像与 RAG 证据</td>
  </tr>
  <tr>
    <td>规则写死，上线即冻结</td>
    <td>围绕数据集、评测、优化、版本对比与人审门禁持续进化</td>
  </tr>
  <tr>
    <td>难以接入业务</td>
    <td>提供 Skill、工作台、运行时桥接和版本化迭代链路</td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">维度</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">含义</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">规模</font></th>
  </tr>
  <tr>
    <td>window_scan</td>
  ...
  <tr>
    <td>direct_request</td>
    <td>直接请求场景，判断上游请求是否明确指向未成年人识别</td>
    <td><code>40</code></td>
  </tr>
  <tr>
    <td>should_trigger</td>
    <td>必须触发的正样本</td>
    <td><code>80</code></td>
  </tr>
  <tr>
    <td>should_not_trigger</td>
    <td>不能误触发的负样本</td>
    <td><code>80</code></td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">问题</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">说明</font></th>
  </tr>
  <tr>
    <td align="center">1</td>
    <td>当前聊天窗口是否已经出现足够的未成年人信号</td>
  </tr>
  <tr>
    <td align="center">2</td>
    <td>上游请求是否真的在要求未成年人识别</td>
  </tr>
  <tr>
    <td align="center">3</td>
    <td>哪些样本属于强触发边界，哪些样本只是“看起来像”但还不该触发</td>
  </tr>
</table>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">资源</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">入口</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">说明</font></th>
  </tr>
  <tr>
    <td>社交对话数据集</td>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">数据模块</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">作用</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">规模</font></th>
  </tr>
  <tr>
    <td>Benchmark</td>
    <td>评估真实未成年人信号与成人近似样本之间的区分能力</td>
    <td><code>8,328</code> 条</td>
  </tr>
  <tr>
    <td>RAG 检索案例库</td>
    <td>提供运行时相似案例辅助判断与离线优化参考</td>
    <td><code>5,829</code> 条</td>
  </tr>
  <tr>
    <td>Trigger-Eval</td>
    <td>优化“什么时候该启动深度识别”的触发边界问题</td>
    <td><code>160</code> 条</td>
  </tr>
</table>

<p><strong>进一步拆开看：</strong></p>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">子集</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">来源 / 场景</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">规模</font></th>
  </tr>
  <tr>
    <td>社交/心理领域</td>
    <td>心理咨询平台真实数据整理后的公开边界版本</td>
    <td><code>2603</code> 正 + <code>1735</code> 负</td>
  </tr>
  <tr>
    <td>知识领域</td>
    <td>K12 课本、课程知识点与成人考试考纲构造</td>
    <td><code>2004</code> 正 + <code>1986</code> 负</td>
  </tr>
  <tr>
    <td>Trigger-Eval</td>
    <td><code>window_scan</code> 与 <code>direct_request</code> 两类触发场景</td>
    <td><code>120 + 40</code></td>
  </tr>
</table>

<p>这三部分分别承担不同职责：Benchmark 负责评估区分能力，Trigger-Eval 负责优化触发边界，RAG 案例库负责支持运行时相似案例判断和离线优化参考。</p>
...
<table width="100%">
  ...
  <tr>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">开源对象</font></th>
    <th align="center" bgcolor="#0A66C2"><font color="#FFFFFF">价值</font></th>
  </tr>
  <tr>
    <td>Hugging Face 数据集</td>
    <td>提供可复核、可评测、可复现实验的数据基座</td>
  </tr>
  <tr>
    <td>ClawHub Skill</td>
    <td>提供可直接调用的轻量化未成年人检测能力</td>
  </tr>
  <tr>
    <td>GitHub 工具链</td>
    <td>提供自进化、版本对比、人审门禁、运行时桥接与前端展示</td>
  </tr>
</table>
...
如果你希望先直观看系统效果，最适合先启动 Streamlit 演示页：

```bash
streamlit run app_minor_detection.py
```

### 2. 启动 Mode A：Agent 参与的主线迭代

`modeA` 对应真实 Agent 参与的 Skill 主线迭代，入口是：
...
- 让 Agent 在 benchmark 数据集上运行正式 Skill 迭代
- 观察 agent runner 参与下的 judge / compare / optimizer 闭环
- 做更接近真实调用形态的主线能力验证

默认数据集是：

- `data/benchmark/val.jsonl`

### 3. 启动 Mode B：Direct Runner 主线迭代

`modeB` 对应不经过 Agent mediation 的 direct runner 主线迭代，入口是：
...
- 跑 direct runner 版本的主线 loop
- 对比 modeA 与 modeB 的主链表现
- 在不引入 agent 中介的情况下观察 skill 主体能力

默认数据集同样是：

- `data/benchmark/val.jsonl`

### 4. 启动 description 主线：触发边界优化主线

如果你要优化 `skills/minor-detection/SKILL.md` 中 frontmatter 的 `description`，主线入口是：
...
- 只优化 `description`
- 使用 `optimization_set`
- 关注 trigger decision 与 successful skill invocation
- 最终会保留 `final_validation_set` 作为独立验证集
...
### 5. 启动 description 副线：standalone full smoke

如果你要跑 description 相关的副线 full smoke，入口是：
...
- trigger 判断
- skill 激活是否成功
- 完整 minor-detection JSON 输出
- 端到端 full smoke 表现

它不参与 optimizer，也不负责主线版本晋级。

默认数据集：

- `data/trigger_eval/minor_detection_trigger_eval_v1.json`

### 6. 启动 description 最终验证

如果主线 description 已经跑完，需要对最终版本做独立 validation，入口是：
...
- 验证最终 description 优化效果
- 在不接 optimizer 的情况下评估 trigger 边界表现
- 作为主线结束后的独立验证脚本
