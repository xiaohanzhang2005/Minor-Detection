...
PIPELINE = Path(r"reports\skill_agent_loops\20260323_124352\baseline\run-minor-detection-v0-1-0\codex_home\.codex\skills\minor-detect-488bbc2b22\scripts\run_minor_detection_pipeline.py")
PAYLOAD = Path(r"reports\skill_agent_loops\20260323_124352\baseline\run-minor-detection-v0-1-0\eval-0000-knowledge_neg_001001_adult_knowledge_gemini-3-flash-preview_-txt_21916_r0\payload.json")
RESULT_PATH = Path(r"reports\skill_agent_loops\20260323_124352\baseline\run-minor-detection-v0-1-0\eval-0000-knowledge_neg_001001_adult_knowledge_gemini-3-flash-preview_-txt_21916_r0\launcher_result.json")
PIPELINE_OBSERVABILITY_PATH = Path(r"reports\skill_agent_loops\20260323_124352\baseline\run-minor-detection-v0-1-0\eval-0000-knowledge_neg_001001_adult_knowledge_gemini-3-flash-preview_-txt_21916_r0\pipeline_observability.json")
