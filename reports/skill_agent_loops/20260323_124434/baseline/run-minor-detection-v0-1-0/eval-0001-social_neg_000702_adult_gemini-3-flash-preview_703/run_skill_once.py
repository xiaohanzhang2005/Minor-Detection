...
PAYLOAD = Path(r"reports\skill_agent_loops\20260323_124434\baseline\run-minor-detection-v0-1-0\eval-0001-social_neg_000702_adult_gemini-3-flash-preview_703\payload.json")
RESULT_PATH = Path(r"reports\skill_agent_loops\20260323_124434\baseline\run-minor-detection-v0-1-0\eval-0001-social_neg_000702_adult_gemini-3-flash-preview_703\launcher_result.json")
PIPELINE_OBSERVABILITY_PATH = Path(r"reports\skill_agent_loops\20260323_124434\baseline\run-minor-detection-v0-1-0\eval-0001-social_neg_000702_adult_gemini-3-flash-preview_703\pipeline_observability.json")
